  ...
  const steps = [
    {
      ...
      description: language === 'hi' ? 'प्रतिष्ठित ब्रीडर या स्थानीय आश्रयों की खोज करें' : 'Research reputable breeders or local shelters',
    ...
    },
    {
      ...
      description: language === 'hi' ? 'नस्ल-विशिष्ट देखभाल के बारे में जानकारी लें' : 'Learn about breed-specific care requirements',
    ...
    },
    {
      ...
      description: language === 'hi' ? 'कुत्ते की देखभाल की लागत का आकलन करें' : 'Estimate the ongoing costs of dog ownership',
    ...
    },
    {
      ...
      description: language === 'hi' ? 'दैनिक देखभाल और प्रशिक्षण के लिए समय निकालें' : 'Schedule time for daily care and training',
    ...
    },
    {
      ...
      description: language === 'hi' ? 'कुत्ते की देखभाल के बारे में जानकारी प्राप्त करें' : 'Learn about dog care and training methods',
    ...
    },
    {
      ...
      description: language === 'hi' ? 'अपने घर को कुत्ते के लिए सुरक्षित बनाएं' : 'Make your home safe and welcoming for your new pet',
      ...
      <div className={`p-6 rounded-2xl ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-lg`}>
        <div className="text-center mb-8">
          ...
          <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            {language === 'hi' ? 'अपने नए साथी को घर लाने के लिए तैयार हो जाइए' : 'Get ready to bring your new companion home'}
          </p>
        </div>
                ...
                <div className="flex-1">
                  ...
                  <ul className="space-y-1">
                    {step.tips.map((tip, tipIndex) => (
                      <li
                        key={tipIndex}
                        className={`text-xs flex items-center gap-2 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}
                      >
